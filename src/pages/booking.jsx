    ...
    <div className="container fade-in" style={{ padding: '4rem 2rem' }}>
      ...
      <div className="booking-layout">
        ...
        <form className="glass-card booking-form" onSubmit={handleSubmit}>
          ...
          <a 
            href={`https://wa.me/919087654321?text=Hi! I would like to make an enquiry for: ${formData.serviceId ? services.find(s => s.id === parseInt(formData.serviceId))?.name : 'Service'} - Name: ${formData.name}, Email: ${formData.email}, Address: ${formData.address}, Preferred Date: ${formData.date}`} 
            target="_blank" 
